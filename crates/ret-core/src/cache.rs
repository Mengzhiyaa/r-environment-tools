...
use crate::{manager::EnvManager, r_installation::RInstallation};
...
/// Type alias for caching R installations by their path.
pub type InstallationCache = LocatorCache<PathBuf, RInstallation>;
