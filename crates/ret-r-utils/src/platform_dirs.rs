...
/// Provides cross-platform user directory resolution (inspired by Python's platformdirs).
...
impl Platformdirs {
    ...
    /// Returns the user cache path for the application.
    pub fn user_cache_path(&self) -> Option<PathBuf> {
        self.user_cache_dir()
    }

    /// Returns the user cache directory for the application.
    ...
    /// Returns the user configuration directory for the application.
